...
//			MotorA_Capture_Count=65535-MotorA_Capture_Count;
			*motorA_speed+=(double)MotorA_Capture_Count*0.033f*3.14*2.0f/0.10f/4.0f/500.0f/30.0f * 0.1f*77.333f;
...
//			MotorB_Capture_Count=65535-MotorB_Capture_Count;
			*motorB_speed+=(double)MotorB_Capture_Count*0.033f*3.14*2.0f/0.10f/4.0f/500.0f/30.0f * 0.1f*77.333f;
